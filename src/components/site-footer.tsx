...
// ─────────────────────────────────────────────────────────────────────────────
// Built & designed by Akshat Tiwari
// https://www.linkedin.com/in/akshat-tiwari-5279a524b/
// ─────────────────────────────────────────────────────────────────────────────
        ...
        <div className="container-page py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Link
                to="/support"
                className="inline-flex h-11 items-center rounded-full bg-accent-pulse px-6 text-sm font-medium text-white hover:bg-[#196f4a]"
              >
                Partner with us
              </Link>
              <Link
                to="/technology"
                className="inline-flex h-11 items-center rounded-full border border-hairline bg-bg-base px-6 text-sm font-medium text-text-primary hover:border-text-muted"
              >
        ...
        <div className="container-page grid gap-10 py-14 md:grid-cols-4">
          <div className="md:col-span-1">
            <div className="flex items-center text-base font-semibold tracking-tight">
              <img src={`${import.meta.env.BASE_URL}logo.png`} alt="Pulse AI Logo" className="h-5 w-auto object-contain select-none dark:brightness-110" />
            </div>
