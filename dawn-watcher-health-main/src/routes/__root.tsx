...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pulse AI — Agentic clinical AI for patient deterioration" },
      { name: "description", content: "Pulse AI builds agentic clinical AI that predicts patient deterioration — starting in oncology, with remote monitoring and rehabilitation today." },
