    ...
    <>
      <section className="container-page py-24 md:py-32">
        <Reveal className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="mt-5 text-4xl font-bold leading-[1.05] tracking-tight md:text-6xl text-text-primary">
            How the AI thinks.
          </h1>
      ...
      <section className="border-t border-hairline bg-bg-panel">
        <div className="container-page py-24">
          <div className="grid gap-8 md:grid-cols-2">
            {steps.map((s) => (
              <Reveal key={s.n} className="card-elevated card-elevated-hover p-8">
                <p className="eyebrow">{s.n}</p>
                <h3 className="mt-4 text-2xl font-bold tracking-tight text-text-primary md:text-3xl">{s.title}</h3>
